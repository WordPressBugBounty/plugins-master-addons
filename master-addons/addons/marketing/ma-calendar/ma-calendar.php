...
/**
 * Stub class for CustomFieldsModule (not implemented)
 */
if (!class_exists('MasterAddons\Addons\CustomFieldsModule')) {
    class CustomFieldsModule {
        public function get_field_types() { return []; }
        public function get_component($type) { return null; }
    }
}
...
class Calendar extends Master_Widget
{
    ...
    {
        return __('Calendar', 'master-addons' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'         => 'manual',
                'options'        => [
                    'manual'     => __('Manual', 'master-addons' ),
                    'posts'     => __('Posts', 'master-addons' ),
                ],
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => __('Conference', 'master-addons' ),
            ]
        );
        ...
        $repeater->add_control(
            'start',
            [
                'label'        => __('Start Date', 'master-addons' ),
        ...
        $repeater->add_control(
            'end',
            [
                'label'        => __('End Date', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::DATE_TIME,
                'picker_options' => [
                    'enableTime' => false,
                ],
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Fetch Dates From', 'master-addons' ),
                'type'         => Controls_Manager::SELECT,
                'default'     => 'post_date',
                'condition'        => [
                    'source'    => 'posts',
                ...
                'options'    => array_merge(
                    ['post_date' => __('Post Date', 'master-addons' ),],
        ...
        foreach (Helper::ma_el_get_post_types() as $post_type => $label) {
            ...
            foreach ($customfields->get_field_types() as $field_type => $label) {
                ...
                $fields_options = [
                    'placeholder'    => /* translators: %s: Date. */ sprintf(__('Search %s Date Fields', 'master-addons' ), $post_type_label),
                    'description'    => /* translators: %s: Field Name. */ sprintf(__('Search %s fields by label or name', 'master-addons' ), strtolower($field_type)),
                    'type'             => 'jltma-query',
                    'options'         => [],
                    'label_block'     => false,
                    'multiple'         => false,
                ...
                $this->add_control(
                    ...
                    array_merge($fields_options, ['label' => __('Start Date', 'master-addons' ),])
                );

                $this->add_control(
                    'post_end_date_' . $field_type . '_' . $post_type,
                    array_merge($fields_options, ['label' => __('End Date', 'master-addons' ),])
                );
            }
        }
        ...
        $this->add_control(
            'no_events',
            [
                'label'        => __('Handle No Events', 'master-addons' ),
                'separator' => 'before',
                'type'         => Controls_Manager::SELECT,
                'default'     => '',
                'options'        => [
                    ''            => __('Show Calendar', 'master-addons' ),
                    'hide'        => __('Hide Calendar', 'master-addons' ),
                    'message'    => __('Show Message', 'master-addons' ),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'         => Controls_Manager::TEXT,
                'default'     => __('There are currently no available events.', 'master-addons' ),
                'condition' => [
                    'no_events' => 'message',
                ],
            ]
        ...
        $this->start_controls_section(
            'section_calendar',
            [
                'label'     => __('Calendar', 'master-addons' ),
            ]
        );
        ...
        $this->add_control(
            'display_heading',
            [
                'label'        => __('Display', 'master-addons' ),
        ...
        $this->add_control(
            'skin',
            [
                'label'         => __('Skin', 'master-addons' ),
                'type'         => Controls_Manager::SELECT,
                'default'     => 'default',
                'options'    => [
                    'default'     => __('Default', 'master-addons' ),
                    'compact'     => __('Compact', 'master-addons' ),
                ],
                'prefix_class'     => 'jltma-calendar-skin--',
            ]
        );
        ...
        $this->add_control(
            'first_day',
            [
                'label'        => __('First Day', 'master-addons' ),
                'type'         => Controls_Manager::SELECT,
                'default'     => '1',
                'options'    => [
        ...
        $this->add_control(
            'constrain_start',
            [
                'label'        => __('Earliest Month', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::DATE_TIME,
                'picker_options' => [
                    'enableTime' => false,
                    'dateFormat' => 'Y-m',
        ...
        $this->add_control(
            'constrain_end',
            [
                'label'        => __('Latest Month', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::DATE_TIME,
                'picker_options' => [
                    'enableTime' => false,
                    'dateFormat' => 'Y-m',
        ...
        $this->add_control(
            ...
            [
                'label'         => __('Default to Current Month', 'master-addons' ),
        ...
        $this->add_control(
            'default_month',
            [
                'label'        => __('Default Month', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::DATE_TIME,
                'picker_options' => [
                    'enableTime' => false,
                    'dateFormat' => 'Y-m',
        ...
        $this->add_control(
            ...
            [
                'label'         => __('Show Adjacent Days', 'master-addons' ),
                'type'             => Controls_Manager::SWITCHER,
                'default'         => 'yes',
                'label_on'         => __('Yes', 'master-addons' ),
                'label_off'     => __('No', 'master-addons' ),
        ...
        $this->add_control(
            'click_adjacent',
            [
                'label'         => __('Adjacent Click', 'master-addons' ),
                'description'    => __('Clicking on days adjacent to current month navigates to corresponding month', 'master-addons' ),
                'type'             => Controls_Manager::SWITCHER,
                'default'         => '',
                'label_on'         => __('Yes', 'master-addons' ),
                'label_off'     => __('No', 'master-addons' ),
        ...
        $this->add_control(
            'link_is_external',
            [
                'label'         => __('Open in new window', 'master-addons' ),
                'type'             => Controls_Manager::SWITCHER,
                'default'         => '',
                'label_on'         => __('Yes', 'master-addons' ),
                'label_off'     => __('No', 'master-addons' ),
        ...
        $this->add_control(
            'link_no_follow',
            [
                'label'         => __('Add nofollow', 'master-addons' ),
                'type'             => Controls_Manager::SWITCHER,
                'default'         => '',
                'label_on'         => __('Yes', 'master-addons' ),
                'label_off'     => __('No', 'master-addons' ),
        ...
        $this->add_control(
            'day_monday',
            [
                'label'        => __('Monday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Mon', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'day_tuesday',
            [
                'label'        => __('Tuesday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Tue', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'day_wednesday',
            [
                'label'        => __('Wednesday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Wed', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'day_thursday',
            [
                'label'        => __('Thursday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Thu', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'day_friday',
            [
                'label'        => __('Friday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Fri', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'day_saturday',
            [
                'label'        => __('Saturday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Sat', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'day_sunday',
            [
                'label'        => __('Sunday', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Sun', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'link_archive',
            [
                'label'         => __('Link to Archive', 'master-addons' ),
                'type'             => Controls_Manager::SWITCHER,
                'default'         => 'yes',
                'label_on'         => __('Yes', 'master-addons' ),
                'label_off'     => __('No', 'master-addons' ),
        ...
        $this->add_control(
            'month_january',
            [
                'label'        => __('January', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('January', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_february',
            [
                'label'        => __('February', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('February', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_march',
            [
                'label'        => __('March', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('March', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_april',
            [
                'label'        => __('April', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('April', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_may',
            [
                'label'        => __('May', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('May', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_june',
            [
                'label'        => __('June', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('June', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_july',
            [
                'label'        => __('July', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('July', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_august',
            [
                'label'        => __('August', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('August', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_september',
            [
                'label'        => __('September', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('September', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_october',
            [
                'label'        => __('October', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('October', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_november',
            [
                'label'        => __('November', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('November', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'month_december',
            [
                'label'        => __('December', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('December', 'master-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'events_heading',
            [
                'label'        => __('Events List', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'event_list_heading',
            [
                'label'        => __('Heading', 'master-addons' ),
                'type'         => Controls_Manager::TEXT,
                'default'     => __('Posts this month', 'master-addons' ),
                'condition' => [
                    'skin' => 'compact',
                ],
                'frontend_available' => true,
        ...
        $this->add_control(
            'event_title_wrap',
            [
                'label'         => __('Title Wrapping', 'master-addons' ),
                'type'         => Controls_Manager::SELECT,
                'default'     => 'no-wrap',
                'options'    => [
                    'no-wrap'     => __('Single Line', 'master-addons' ),
                    'wrap'         => __('Wrap', 'master-addons' ),
                ],
                'prefix_class'     => 'jltma-calendar-event-title--',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'         => Controls_Manager::TEXT,
                'description' => sprintf('<a href="https://momentjs.com/docs/#/displaying/format/" target="_blank">%s</a>', __('Documentation on ISO date and time formatting', 'master-addons' )),
                'default'     => 'MMMM Do',
                'condition' => [
                    'skin' => 'compact',
                ],
        ...
        $this->add_control(
            'separators_heading',
            [
                'label'        => __('Separators', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::HEADING,
                'separator'    => 'before',
            ]
        );
        ...
        $this->start_controls_tab('separators_horizontal', ['label' => __('Horizontal', 'master-addons' )]);
        ...
        $this->start_controls_tab('separators_vertical', ['label' => __('Vertical', 'master-addons' )]);
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Month Spacing', 'master-addons' ),
                'type'         => Controls_Manager::SLIDER,
                'default'    => [
                    'size'    => 12,
                ],
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Buttons', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => 'sides',
                'options'    => [
                    'sides' => __('Sides', 'master-addons' ),
                    'left'     => __('Left', 'master-addons' ),
                    'right' => __('Right', 'master-addons' ),
                ],
                'prefix_class' => 'jltma-calendar-arrows-position--',
            ]
        );
        ...
        $this->start_controls_tab('buttons_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('buttons_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->add_control(
            'days_all_heading',
            [
                'label'        => __('All Days', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_tab('days_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_event_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_event_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_today_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_today_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_passed_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_passed_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Passed Events', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_tab('days_passed_events_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('days_passed_events_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Adjacent', 'master-addons' ),
                'type'         => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Title Spacing', 'master-addons' ),
                'type'         => Controls_Manager::SLIDER,
                'default'    => [
                    'size'     => 12,
                ],
        ...
        $this->start_controls_tab('event_default', ['label' => __('Default', 'master-addons' )]);
        ...
        $this->start_controls_tab('event_hover', ['label' => __('Hover', 'master-addons' )]);
        ...
        $this->start_controls_section(
            ...
            [
                'tab'         => Controls_Manager::TAB_STYLE,
                'label'     => __('No Events', 'master-addons' ),
                'condition' => [
                    'no_events' => 'message',
                ],
            ]
    ...
    protected function get_posts_data()
    {
         ...
         */
        $args = apply_filters('master_addons/widgets/calendar/events/query/args', $args, $settings);
        ...
        foreach ($posts as $post) {
             ...
             */
            $events[] = apply_filters('master_addons/widgets/calendar/events/event', $event, $post);
        }
         ...
         */
        $this->_events = apply_filters('master_addons/widgets/calendar/events', $events, $settings);
    }
    ...
    protected function parse_field_query_args($args, $type)
    {
        ...
        $start_date_key = $settings['post_start_date_' . esc_attr($settings['post_dates_field_type']) . '_' . esc_attr($settings['post_type'])];
    ...
    protected function get_field_dates_args($post)
    {
        ...
        if ($post) {
            ...
            $start_date_key     = $settings['post_start_date_' . esc_attr($settings['post_dates_field_type']) . '_' . esc_attr($settings['post_type'])];
            $end_date_key         = $settings['post_end_date_' . esc_attr($settings['post_dates_field_type']) . '_' . esc_attr($settings['post_type'])];
    ...
    protected function setup_manual()
    {
         ...
         */
        $this->_events = apply_filters('master_addons/widgets/calendar/events/manual', $events, $settings);
    }
...
<?php
    ...
    public function get_before_title($event)
    {
         ...
         */
        do_action('master_addons/widgets/calendar/event/before_title', $event);
    ...
    public function get_after_title($event)
    {
         ...
         * @param array $event The event data.
         */
        do_action('master_addons/widgets/calendar/event/after_title', $event);
