 ...
 */
class Timeline extends Master_Widget
{
	...
	protected function register_controls()
	{
		...
		$timeline_type_options = apply_filters('master_addons/addons/timeline/type', [
		...
		$this->add_control(
			...
			[
				...
				'description'        => Helper::upgrade_to_pro('Post Timeline on'),
			]
		);
		...
		// Pro adds post timeline controls via this filter (see Free_Addons.php -> timeline_content_controls)
		apply_filters('master_addons/addons/timeline/content_controls', $this);
		...
		// Pro adds Style tab via this filter (see Free_Addons.php -> timeline_style_controls)
		apply_filters('master_addons/addons/timeline/tabs_style_controls', $repeater);
		...
		*/
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'ma_el_timeline_type'         => 'post',
					'ma_el_timeline_post_title!'  => '',
					'ma_el_timeline_excerpt_type' => 'three_dots',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					{{WRAPPER}} .jltma-timeline .timeline-item__excerpt p' => 'color: {{VALUE}};',
				],
				'condition'			=> [
					'ma_el_timeline_type'         => 'post',
					'ma_el_timeline_post_title!'  => '',
		...
		// 		'selector' => '{{WRAPPER}} .jltma-timeline .timeline-item__excerpt, {{WRAPPER}} .jltma-timeline .timeline-item__excerpt p',
		// 		'global'   => [
		...
		$this->add_control(
			'ma_el_timeline_read_more_heading',
			[
				'label'     => __('Read More Button', 'master-addons'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'ma_el_timeline_type'         => 'post',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'      => 'ma_el_timeline_read_more_typography',
				'selector'  => '{{WRAPPER}} .jltma-timeline .jltma-post-btn',
				'condition' => [
					'ma_el_timeline_type'         => 'post',
					'ma_el_timeline_excerpt_type' => 'read_more_link',
				],
		...
		$this->add_responsive_control(
			'ma_el_timeline_read_more_padding',
			[
				'label'      => __('Padding', 'master-addons'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-timeline .jltma-post-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'ma_el_timeline_type'         => 'post',
					'ma_el_timeline_excerpt_type' => 'read_more_link',
		...
		$this->add_responsive_control(
			'ma_el_timeline_read_more_border_radius',
			[
				'label'      => __('Border Radius', 'master-addons'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-timeline .jltma-post-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'ma_el_timeline_type'         => 'post',
					'ma_el_timeline_excerpt_type' => 'read_more_link',
		...
		$this->start_controls_tab(
			'ma_el_timeline_read_more_normal_tab',
			[
		...
		$this->add_control(
			'ma_el_timeline_read_more_color',
			[
				'label'     => __('Text Color', 'master-addons'),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-post-btn' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'ma_el_timeline_read_more_background',
		...
		$this->add_group_control(
			...
			[
				'name'     => 'ma_el_timeline_read_more_border',
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-post-btn',
			]
		);
		...
		// Hover Tab
		$this->start_controls_tab(
			'ma_el_timeline_read_more_hover_tab',
			[
		...
		$this->add_control(
			'ma_el_timeline_read_more_hover_color',
			[
				'label'     => __('Text Color', 'master-addons'),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-post-btn:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[
				'name'     => 'ma_el_timeline_read_more_hover_background',
				'types'    => ['classic', 'gradient'],
				'exclude'  => ['image'],
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-post-btn:hover',
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => 'ma_el_timeline_read_more_hover_border',
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-post-btn:hover',
			]
		);
		...
		*/
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					{{WRAPPER}} .jltma-timeline .jltma-timeline-entry-content *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .jltma-timeline .timeline-item__card .timeline-item__card__arrow::after' => 'border-left-color: {{VALUE}}; border-right-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper, {{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper *',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .timeline-item__content-wrapper,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .timeline-item__content-wrapper *,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-entry-content,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-entry-content *,
					{{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper:hover,
					{{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper:hover *,
					{{WRAPPER}} .jltma-timeline .jltma-timeline-entry-content:hover,
					{{WRAPPER}} .jltma-timeline .jltma-timeline-entry-content:hover *' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:not(.is--focused):hover .timeline-item__content-wrapper,
					{{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper:hover' => 'background-color: {{VALUE}} !important;',
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:not(.is--focused):hover .timeline-item__card .timeline-item__card__arrow::after' => 'border-left-color: {{VALUE}} !important; border-right-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .timeline-item__content-wrapper, {{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper:hover',
			]
		);
		...
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			[
				'name'     => 'cards_text_shadow_hover',
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .timeline-item__content-wrapper, {{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .timeline-item__content-wrapper *',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__content-wrapper,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__content-wrapper *,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-entry-content,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-entry-content *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__content-wrapper' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__card__arrow::after' => 'border-left-color: {{VALUE}}; border-right-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__content-wrapper',
			]
		);
		...
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			[
				'name'     => 'cards_text_shadow_focused',
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__content-wrapper, {{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .timeline-item__content-wrapper *',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-timeline .timeline-item__content-wrapper, {{WRAPPER}} .jltma-timeline .jltma-timeline-entry-content',
				'global'   => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
				],
				'condition'		=> [
		...
		* Timeline Style: Line
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon'                              => 'width: {{SIZE}}px; height: {{SIZE}}px',
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-mini-thumb'                             => 'width: {{SIZE}}px; height: {{SIZE}}px',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon' => 'font-size: {{SIZE}}em',
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon svg' => 'font-size: {{SIZE}}em',
				],
				'condition'		=> [
					'ma_el_timeline_points_content' => 'icons'
				]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon.timeline-item__point__text' => 'font-size:{{SIZE}}em;',
				],
				'condition'		=> [
					'ma_el_timeline_points_content!' => 'icons',
				]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon'   => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-mini-thumb' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon' => 'color: {{VALUE}};',
					'{{WRAPPER}} .jltma-timeline .jltma-timeline-post-type-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-type-icon,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-mini-thumb' => 'transform: scale({{SIZE}})',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-type-icon,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-mini-thumb' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-type-icon' => 'color: {{VALUE}};',
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-type-icon svg' => 'fill: {{VALUE}};'
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post:hover .jltma-timeline-post-type-icon'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-type-icon,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-mini-thumb' => 'transform: scale({{SIZE}})',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-type-icon,
					{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-mini-thumb' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-type-icon' => 'color: {{VALUE}};',
					'{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-type-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-timeline .jltma-blog-timeline-post.is--focused .jltma-timeline-post-type-icon',
			]
		);
	...
	protected function render()
	{
		...
		// Post Timeline Pro settings - check if Pro controls exist
		$timeline_pro_features = apply_filters('master_addons/addons/timeline/pro_features', []);
		if (in_array('post', $timeline_pro_features) && isset($settings['ma_el_blog_posts_per_page'])) {
	...
	<?php }
		...
		public function jltma_vertical_timeline()
		{
			...
			foreach ($settings['ma_el_custom_timeline_items'] as $index => $item) {
				...
				// Custom style points - check if Pro controls exist
				if (isset($item['ma_el_custom_timeline_custom_style']) && $item['ma_el_custom_timeline_custom_style'] === 'yes' && isset($item['ma_el_custom_timeline_point_content_type']) && $item['ma_el_custom_timeline_point_content_type'] !== '') {
		...
		<div <?php echo $this->get_render_attribute_string('swiper_container'); ?>>
			<div <?php echo $this->get_render_attribute_string('swiper_wrapper'); ?>>
				...
				<?php foreach ($settings['ma_el_custom_timeline_items'] as $index => $item) {
					...
					if (isset($item['ma_el_custom_timeline_custom_style']) && $item['ma_el_custom_timeline_custom_style'] === 'yes' && isset($item['ma_el_timeline_points_content']) && $item['ma_el_timeline_points_content'] !== '') {
...
<?php }
		...
		protected function ma_timeline_points_icon($item = false)
		{
			...
			$global_icon_migrated = isset($settings['__fa4_migrated']['ma_el_timeline_selected_global_icon']);
			$global_icon_is_new   = empty($settings['global_icon']) && Icons_Manager::is_migration_allowed();
			$global_icon_value    = isset($settings['ma_el_timeline_selected_global_icon']['value']) ? $settings['ma_el_timeline_selected_global_icon']['value'] : '';
			$has_global_icon      = !empty($settings['global_icon']) || !empty($global_icon_value);
			...
			if ($item && $has_item_icon) {
				if ($item_icon_is_new || $item_icon_migrated) {
					$icon_rendered = trim($this->get_library_point_icon($item['ma_el_custom_timeline_selected_icon']));
				} else if (!empty($item['selected_point_icon'])) {
					$icon_rendered = sprintf($icon_markup, $item['selected_point_icon']);
				}
			}

			// If no item icon rendered, try global icon
			if (empty(trim($icon_rendered)) && $has_global_icon) {
				if ($global_icon_is_new || $global_icon_migrated) {
					$icon_rendered = trim($this->get_library_point_icon($settings['ma_el_timeline_selected_global_icon']));
				} else if (!empty($settings['global_icon'])) {
					$icon_rendered = sprintf($icon_markup, $settings['global_icon']);
				}
			}

			// Fallback: render default circle if nothing rendered
			if (empty(trim($icon_rendered))) {
				$icon_rendered = '<span class="jltma-timeline-circle"></span>';
			}

			$output .= $icon_rendered;
			$output .= '</div>';
		...
		{
			// Static counter to track post index for numbers/letters (0-based)
			static $post_index = -1;
			$post_index++;
			...
			// Point content - check if Pro controls exist
			if (isset($settings['ma_el_timeline_points_content']) && $settings['ma_el_timeline_points_content'] !== '') {
				...
				// Free version: show default circle point
				$point_content = '<div class="jltma-timeline-post-type-icon jltma-timeline__item__icon"><span class="jltma-timeline-circle"></span></div>';
			}
?>
					...
					<div class="timeline-item__content-wrapper">
						...
						<div class="jltma-timeline-entry-content">
							<?php if ($settings['ma_el_timeline_post_title'] == "yes") { ?>
								<<?php echo esc_html($title_html_tag); ?> class="jltma-timeline-entry-title">
