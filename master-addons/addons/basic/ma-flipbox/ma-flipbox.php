...
class Flipbox extends Master_Widget
{
	...
	protected function register_controls()
	{
		...
		$layout_style_options = apply_filters('master_addons/addons/flipbox/layout_style', [
		...
		$this->add_control(
			...
			[
				...
				'default'     => 'one',
				'description' => Helper::upgrade_to_pro('2+ more Variations on'),
			]
		);

		// Define default free options - Pro version overrides via filter
		$animation_style_options = apply_filters('master_addons/addons/flipbox/animation_style', [
		...
		$this->add_control(
			...
			[
				...
				'description'  => Helper::upgrade_to_pro('15+ more Flipbox Variations on'),
			]
		);
	...
	protected function render()
	{
		...
		$front_title_tag = in_array($settings['front_title_html_tag'], $allowed_tags, true)
			? $settings['front_title_html_tag']
			: 'h3';
		$back_title_tag = in_array($settings['back_title_html_tag'], $allowed_tags, true)
			? $settings['back_title_html_tag']
			: 'h3';
