...
class Team_Member extends Master_Widget
{
	...
	protected function register_controls()
	{
		...
		$members_preset_options = apply_filters('master_addons/addons/team_members/members_preset', [
		...
		$this->add_control(
			...
			[
				...
				'default'     => '-basic',
				'options'     => $members_preset_options,
				'description' => Helper::upgrade_to_pro('5+ more Variations on'),
			]
		);
