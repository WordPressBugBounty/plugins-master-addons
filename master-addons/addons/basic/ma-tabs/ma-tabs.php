...
class Tabs extends Master_Widget
{
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'description' => Helper::upgrade_to_pro('Tabular Content on'),
			]
		);
		...
		$tabs_layout_controls = apply_filters('master_addons/addons/tabs/layout_controls', [
			[
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Column Layout available on'),
				],
			],
			[
				'type'       => 'responsive_control',
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Icon & Tabs Style available on'),
				],
			],
			[
				'type'       => 'responsive_control',
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Tabs & Content Style available on'),
				],
			],
			[
				'type'       => 'control',
				...
				'args'       => [
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Tabs Orientation available on'),
				],
			],
		]);
