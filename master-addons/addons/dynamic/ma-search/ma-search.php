...
use MasterAddons\Inc\Controls\JLTMA_Visual_Select;
 ...
 * MA Header Search
 */
class Search extends Master_Widget
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'   => '#fff',
                'selectors' => array(
                    '{{WRAPPER}} .jltma-btn--search i, {{WRAPPER}} .jltma-btn--search .dashicons, {{WRAPPER}} .jltma-search-form .jltma-search-submit i, {{WRAPPER}} .jltma-search-form .jltma-search-submit .dashicons' => 'color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'   => '#303030',
                'selectors' => array(
                    '{{WRAPPER}} .jltma-search-form .jltma-search-submit, {{WRAPPER}} .jltma-btn--search' => 'background-color: {{VALUE}}',
                )
            )
        );
                    ...
                    <div class="jltma-search-wrap">
                        <button id="jltma-btn-search" class="jltma-btn--search">
                            ...
                            if (!empty($jltma_search_icon['value'])) {
                                Icons_Manager::render_icon($jltma_search_icon, ['aria-hidden' => 'true']);
                            } else {
