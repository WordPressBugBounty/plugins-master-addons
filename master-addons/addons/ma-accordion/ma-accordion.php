...
class JLTMA_Advanced_Accordion extends Widget_Base {
    ...
    protected function register_controls() {
         ...
         */
        $this->start_controls_section( 'section_accordion_tabs', [
        ...
        $repeater->add_control( 'accordion_tab_default_active', [
            'label'        => esc_html__( 'Active as Default', 'master-addons' ),
            'type'         => Controls_Manager::SWITCHER,
            'default'      => 'no',
            'return_value' => 'yes',
        ] );
        $repeater->add_control( 'accordion_tab_icon_show', [
        ...
        $repeater->start_controls_tab( 'accordion_tab_icon_custom_expand', [
            'label'     => __( 'Expand Icon', 'master-addons' ),
            'condition' => [
                'accordion_tab_icon_show' => 'yes',
            ],
        ] );
        $repeater->add_control( 'accordion_tab_title_icon', [
        ...
        $repeater->start_controls_tab( 'accordion_tab_icon_custom_collapse', [
            'label'     => __( 'Collapse Icon', 'master-addons' ),
            'condition' => [
                'accordion_tab_icon_show' => 'yes',
            ],
        ] );
        $repeater->add_control( 'accordion_tab_title_icon_collapse', [
            'label'            => esc_html__( 'Icon', 'master-addons' ),
            'description'      => esc_html__( 'Please choose an icon from the list.', 'master-addons' ),
            'type'             => Controls_Manager::ICONS,
        ...
        $repeater->add_control( 'single_tab_title_bg_color_show_pro', [
        ...
        $repeater->add_control( 'single_title_text_color_pro', [
        ...
        $repeater->add_control( 'single_tab_title_bg_color_pro', [
        ...
        $repeater->add_control( 'single_title_content_color_pro', [
        ...
        $repeater->add_control( 'single_tab_content_bg_color_pro', [
        ...
        $this->add_control( 'toggle_icon_show', [
         ...
         * Style Tab: Items
         */
        $this->start_controls_section( 'section_accordion_items_style', [
            'label' => esc_html__( 'Items', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_responsive_control( 'accordion_items_spacing', [
        ...
        $this->add_responsive_control( 'accordion_items_border_radius', [
        ...
        $this->start_controls_tab( 'accordion_tab_normal', [
        ...
        $this->add_control( 'tab_title_text_color', [
        ...
        $this->add_responsive_control( 'jltma_accordion_border_radius', array(
            'label'      => esc_html__( 'Border Radius', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array('px', '%'),
            'selectors'  => array(
        ...
        $this->start_controls_tab( 'accordion_tab_hover', [
        ...
        $this->add_control( 'tab_title_text_color_hover', [
            'label'     => esc_html__( 'Text Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'tab_title_border_color_hover', [
        ...
        $this->add_responsive_control( 'jltma_accordion_border_radius_hover', array(
            'label'      => esc_html__( 'Border Radius', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array('px', '%'),
            'selectors'  => array(
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'accordion_tab_active', [
        ...
        $this->add_control( 'tab_title_text_color_active', [
            'label'     => esc_html__( 'Text Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'tab_title_border_color_active', [
            'label'     => esc_html__( 'Border Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'jltma_accordion_border_radius_active', array(
            'label'      => esc_html__( 'Border Radius', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array('px', '%'),
            'selectors'  => array(
        ...
        $this->add_responsive_control( 'jltma_accordion_box_padding', [
        ...
        $this->add_control( 'tab_content_bg_color', [
            'label'     => esc_html__( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
        ...
        $this->add_control( 'tab_content_text_color', [
            'label'     => esc_html__( 'Text Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#333',
            'selectors' => [
         ...
         * Style Tab
         */
        $this->start_controls_section( 'section_toggle_icon_style', [
        ...
        $this->add_responsive_control( 'toggle_icon_position', array(
        ...
        $this->start_controls_tab( 'toggle_icons_tab_expand', [
            'label' => __( 'Expand Icon', 'master-addons' ),
        ] );
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'toggle_icons_tab_collapse', [
            'label' => __( 'Collapse Icon', 'master-addons' ),
        ] );
        ...
        $this->end_controls_tab();
        $this->end_controls_tabs();
        $this->add_control( 'toggle_icons_color_heading', [
            'label'     => __( 'Icon Settings', 'master-addons' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );
        $this->start_controls_tabs( 'toggle_icons_color_tabs' );
        $this->start_controls_tab( 'toggle_icons_color_normal', [
            'label' => __( 'Normal', 'master-addons' ),
        ] );
        $this->add_group_control( Group_Control_Background::get_type(), [
            'name'      => 'toggle_icon_bg',
        ...
        $this->add_responsive_control( 'tab_icon_spacing', [
        ...
        $this->add_responsive_control( 'toggle_icon_padding', [
            'label'      => esc_html__( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'toggle_icons_color_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_group_control( Group_Control_Background::get_type(), [
        ...
        $this->add_responsive_control( 'toggle_icon_size_hover', [
            'label'      => __( 'Icon Size', 'master-addons' ),
            'type'       => Controls_Manager::SLIDER,
            'default'    => [
                'size' => 16,
        ...
        $this->add_responsive_control( 'toggle_icon_padding_hover', [
            'label'      => esc_html__( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'toggle_icons_color_active', [
            'label' => __( 'Active', 'master-addons' ),
        ] );
        $this->add_group_control( Group_Control_Background::get_type(), [
        ...
        $this->add_control( 'toggle_icon_color_active', [
            'label'     => esc_html__( 'Icon Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'toggle_icon_size_active', [
            'label'      => __( 'Icon Size', 'master-addons' ),
            'type'       => Controls_Manager::SLIDER,
            'default'    => [
                'size' => 16,
        ...
        $this->add_responsive_control( 'toggle_icon_padding_active', [
            'label'      => esc_html__( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
    ...
    protected function render() {
        ...
        if ( !empty( $settings['toggle_icon_position'] ) ) {
            $toggle_icon_position = $settings['toggle_icon_position'];
        }
        $this->add_render_attribute( [
            'jltma-accordion-wrap' => [
                'class' => ['ma-accordion-wrap', 'ma-accordion-icon-align-' . esc_attr( $toggle_icon_position ), 'id' => 'ma-accordion-' . esc_attr( $this->get_id() )],
            ],
        ] );
        ?>
        ...
        foreach ( $settings['tabs'] as $index => $tab ) {
            ...
            ?>
							...
							<?php 
            if ( $settings['toggle_icon_show'] === 'yes' && $settings['toggle_icon_position'] == "right" ) {
                if ( $tab['accordion_tab_icon_show'] === 'yes' ) {
                    ?>
									<span class="jltma-accordion-toggle-icon jltma-accordion-tab-icon">
										<?php 
