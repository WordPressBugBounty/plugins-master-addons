...
class Advanced_Image extends Master_Widget
{
	...
	{
		return 'jltma-icon ' . Config::get_addon_icon('ma-advanced-image');
	}
...
protected function register_controls()
	{
		...
		$this->add_control(
			...
			array(
				...
				'label_block'  => true,
				'type'         => Controls_Manager::SELECT,
				'options'      => Helper::jltma_get_preloadable_previews(),
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => array(
	...
	protected function render()
	{
		...
		$args        = array(
			...
			'width'            => Helper::jltma_get_array_value($settings['ma_el_adv_image_custom_dimension'], 'width'),
			'height'           => Helper::jltma_get_array_value($settings['ma_el_adv_image_custom_dimension'], 'height'),
