...
class Image_Comparison extends Master_Widget
{
	...
	protected function register_controls()
	{
		...
		$move_handle_options = apply_filters('master_addons/addons/image_comparison/move_handle', [
		...
		$this->add_control(
			...
			[
				...
				'default'        => 'drag',
				'options'        => $move_handle_options,
				'style_transfer' => true,
				'description'    => Helper::upgrade_to_pro('2+ more Handle Options on'),
			]
		);
		...
		// Border radius & box shadow - Pro version overrides via filter
		$border_radius_controls = apply_filters('master_addons/addons/image_comparison/border_radius', [
			[
				'type'       => 'responsive_control',
				'control_id' => 'jltma_image_comparison_container_border_radius',
				'args'       => [
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Border Radius on'),
				],
			],
			[
				'type'       => 'responsive_control',
				'control_id' => 'jltma_image_comparison_container_box_shadow',
				'args'       => [
					'label'       => __('Box Shadow (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
						'1' => [
							'title' => esc_html__('', 'master-addons'),
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Box Shadow on'),
				],
			],
		]);

		// Add all controls from the filter
		foreach ($border_radius_controls as $control) {
