...
class Image_Hover_Effects extends Master_Widget
{
	...
	protected function register_controls()
	{
		...
		$hover_effect_options = apply_filters('master_addons/addons/image_hover_effects/hover_effect', [
		...
		$this->add_control(
			...
			[
				...
				'description' => Helper::upgrade_to_pro('20+ more effects on'),
			]
		);
		...
		// Define default free options - Pro version overrides via filter
		$popup_type_options = apply_filters('master_addons/addons/image_hover_effects/popup_type', [
		...
		$this->add_control(
			...
			[
				...
				'default'     => 'content',
				'description' => Helper::upgrade_to_pro('Popup Content Types on'),
				'condition'   => [
		...
		// Image styling Pro controls - filtered through Free_Addons.php
		$image_styling_controls = apply_filters('master_addons/addons/image_hover_effects/image_styling', [
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_border_radius_pro',
				'args'       => [
					'label'       => __('Border Radius (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
						'1' => [
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Border Radius available on'),
				],
			],
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_pading_pro',
				'args'       => [
					'label'       => __('Padding (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
						'1' => [
							'title' => esc_html__('', 'master-addons'),
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Padding available on'),
				],
			],
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_margin_pro',
				'args'       => [
					'label'       => __('Margin (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
						'1' => [
							'title' => esc_html__('', 'master-addons'),
					...
					'default'     => '1',
					'description' => Helper::upgrade_to_pro('Margin available on'),
				],
			],
		]);

		foreach ($image_styling_controls as $control) {
			if ($control['type'] === 'responsive_control') {
		...
		// Title styling Pro controls - filtered through Free_Addons.php
		$title_styling_controls = apply_filters('master_addons/addons/image_hover_effects/title_styling', [
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_title_pading_pro',
				'args'       => [
					'label'       => __('Padding (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
			...
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_title_margin_pro',
				'args'       => [
					'label'       => __('Margin (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
		...
		foreach ($title_styling_controls as $control) {
			if ($control['type'] === 'responsive_control') {
				$this->add_responsive_control($control['control_id'], $control['args']);
			}
		}
		...
		// Description styling Pro controls - filtered through Free_Addons.php
		$desc_styling_controls = apply_filters('master_addons/addons/image_hover_effects/desc_styling', [
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_desc_pading_pro',
				'args'       => [
					'label'       => __('Padding (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
			...
			[
				'type'       => 'responsive_control',
				'control_id' => 'ma_el_main_image_desc_margin_pro',
				'args'       => [
					'label'       => __('Margin (Pro)', 'master-addons'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
		...
		foreach ($desc_styling_controls as $control) {
			if ($control['type'] === 'responsive_control') {
				$this->add_responsive_control($control['control_id'], $control['args']);
			}
		}
	...
	protected function render()
	{
		...
		// Get hover effects from filter
		$hover_effects = apply_filters('master_addons/addons/image_hover_effects/hover_effect', [
			'lily'   => __('Lily', 'master-addons'),
			'sadie'  => __('Sadie', 'master-addons'),
			'roxy'   => __('Roxy', 'master-addons'),
			'bubba'  => __('Bubba', 'master-addons'),
		...
		$effect_keys = array_keys($hover_effects);
		$selected_effect = $settings['ma_el_main_image_effect'];
		$effect_index = array_search($selected_effect, $effect_keys);

		// Determine effect set based on position (first 15 = one, rest = two)
		$ma_el_image_hover_sets = ($effect_index !== false && $effect_index < 15) ? "one" : "two";
		...
		// 	echo Helper::jltma_custom_message('No Image Selected', 'Please Upload/Select an Image');
		// }
		...
		<div <?php echo $this->get_render_attribute_string('ma_el_image_hover_effect_wrapper'); ?>>
			...
			<figure class="jltma-effect-<?php echo esc_attr($settings['ma_el_main_image_effect']); ?>">
				...
				<figcaption>
					...
					<?php
					// Link types filter - Free version only has 'links', Pro adds 'popup'
					$enabled_link_types = apply_filters('master_addons/addons/image_hover_effects/link_types', ['links']);
					...
					<?php } elseif (in_array('popup', $enabled_link_types) && $settings['ma_el_image_hover_link_type'] == "popup") { ?>
						...
						<a data-fancybox data-src="#jltma-image-hover-<?php echo esc_attr($this->get_id()); ?>" href="javascript:;"
						...
						<div style="display: none;" id="jltma-image-hover-<?php echo esc_attr($this->get_id()); ?>">
