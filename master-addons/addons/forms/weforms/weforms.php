...
class Weforms extends Master_Widget
{
	...
	{
		return 'jltma-icon ' . Config::get_addon_icon('weforms');
	}
	...
	protected function register_controls()
	{
		...
		$layout_style_options = apply_filters('master_addons/addons/weform/layout_style', [
	...
	protected function render()
	{
		...
		if (!class_exists('WeForms')) {
			Helper::jltma_elementor_plugin_missing_notice(array(
				'title'       => esc_html__('weForms is Not Activated!', 'master-addons'),
				'description' => esc_html__('To use this widget, please install and activate the "weForms" plugin.', 'master-addons'),
			));
			return;
		} ?>
