...
class WP_Forms extends Master_Widget
{
	...
	{
		return 'jltma-icon ' . Config::get_addon_icon('wpforms');
	}
	...
	protected function register_controls()
	{
		...
		$layout_style_options = apply_filters('master_addons/addons/wpforms/layout_style', [
	...
	protected function render()
	{
		...
		if (!function_exists('wpforms')) {
			Helper::jltma_elementor_plugin_missing_notice(array(
				'title'       => esc_html__('WPForms is Not Activated!', 'master-addons'),
				'description' => esc_html__('To use this widget, please install and activate the "WPForms" plugin.', 'master-addons'),
			));
			return;
		}
