...
class Caldera_Forms extends Master_Widget
{
	...
	{
		return 'jltma-icon ' . Config::get_addon_icon('caldera-forms');
	}
	...
	protected function register_controls()
	{
		...
		$this->jltma_help_docs('caldera-forms');
	...
	protected function render()
	{
		...
		if (!class_exists('Caldera_Forms')) {
			Helper::jltma_elementor_plugin_missing_notice(array(
				'title'       => esc_html__('Caldera Forms is Not Activated!', 'master-addons'),
				'description' => esc_html__('To use this widget, please install and activate the "Caldera Forms" plugin.', 'master-addons'),
			));
			return;
		}
