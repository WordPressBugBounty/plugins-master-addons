 ...
 */
class Ninja_Form extends Master_Widget
{
	...
	{
		return 'jltma-icon ' . Config::get_addon_icon('ninja-forms');
	}
	...
	protected function register_controls()
	{
		...
		$layout_style_options = apply_filters('master_addons/addons/ninja_forms/layout_style', [
		...
		$this->jltma_help_docs('ninja-forms');
	...
	protected function render()
	{
		...
		if (!class_exists('Ninja_Forms')) {
			Helper::jltma_elementor_plugin_missing_notice(array(
				'title'       => esc_html__('Ninja Forms is Not Activated!', 'master-addons'),
				'description' => esc_html__('To use this widget, please install and activate the "Ninja Forms" plugin.', 'master-addons'),
			));
			return;
		}
