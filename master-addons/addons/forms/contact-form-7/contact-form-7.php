...
class Contact_Form_7 extends Master_Widget
{
	...
	{
		return 'jltma-icon ' . Config::get_addon_icon('contact-form-7');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'options' => Helper::maad_el_retrive_cf7(),
				'default' => '0',
			]
		);
		...
		$layout_style_options = apply_filters('master_addons/addons/contact_form_7/layout_style', [
		...
		$this->add_control(
			...
			[
				...
				'description' => Helper::upgrade_to_pro('10+ more Variations on'),
			]
		);
		...
		$this->jltma_help_docs('contact-form-7');
	...
	protected function render()
	{
		...
		if (!function_exists('wpcf7')) {
			Helper::jltma_elementor_plugin_missing_notice(array(
				'title'       => esc_html__('Contact Form 7 is Not Activated!', 'master-addons'),
				'description' => esc_html__('To use this widget, please install and activate the "Contact Form 7" plugin.', 'master-addons'),
			));
			return;
		}
