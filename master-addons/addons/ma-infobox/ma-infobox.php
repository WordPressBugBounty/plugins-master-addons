...
class JLTMA_Infobox extends Widget_Base {
    ...
    public function get_style_depends() {
        return ['font-awesome-5-all', 'font-awesome-4-shim'];
    }
    ...
    protected function register_controls() {
         ...
         */
        $this->start_controls_section( 'ma_el_section_infobox_content', [
            'label' => esc_html__( 'Content', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_infobox_preset', [
        ...
        $this->add_control( 'ma_el_infobox_img_or_icon', [
        ...
        $this->add_control( 'ma_el_infobox_image', [
        ...
        $this->add_control( 'ma_el_infobox_readmore_link', [
         ...
         */
        $this->start_controls_section( 'ma_el_section_infobox_styles_preset', [
        ...
        $this->add_control( 'info_box_border_radius', [
        ...
        $this->add_control( 'info_box_padding', [
        ...
        $this->add_control( 'info_box_margin', [
        ...
        $this->add_control( 'ma_el_infobox_bg_heading', [
            'label' => __( 'Background', 'master-addons' ),
            'type'  => Controls_Manager::HEADING,
        ] );
        $this->start_controls_tabs( 'ma_el_infobox_style' );
        $this->start_controls_tab( 'ma_el_infobox_normal', [
        ...
        $this->start_controls_tab( 'ma_el_infobox_hover', [
        ...
        $this->add_control( 'ma_el_infobox_hover_animation', [
        ...
        $this->start_controls_tab( 'ma_el_infobox_icon_color_normal', [
            'label' => __( 'Normal', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_infobox_icon_size', [
        ...
        $this->add_control( 'ma_el_infobox_bg_fade_icon_size', [
        ...
        $this->add_control( 'ma_el_infobox_icon_color_scheme', [
        ...
        $this->add_control( 'ma_el_infobox_icon_bg_fade_color_scheme', [
        ...
        $this->add_control( 'ma_el_infobox_icon_bg', [
        ...
        $this->add_control( 'ma_el_infobox_hexagon_bg', [
        ...
        $this->add_responsive_control( 'ma_el_infobox_icon_alignment', [
        ...
        $this->add_responsive_control( 'ma_el_infobox_icon_padding', [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'ma_el_infobox_icon_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_infobox_icon_hover_color_scheme', [
        ...
        $this->add_control( 'ma_el_infobox_icon_hover_fade_color_scheme', [
            'label'     => __( 'Icon Hover Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'ma_el_infobox_icon_hover_bg', [
            'label'     => esc_html__( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'ma_el_infobox_icon_bg_fade_hover_color_scheme', [
            'label'     => __( 'BG Icon Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'ma_el_infobox_hexagon_hover_bg', [
            'label'     => __( 'Haxagon BG', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'ma_el_infobox_icon_hover_alignment', [
            'label'       => esc_html__( 'Alignment', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'label_block' => false,
            'options'     => Master_Addons_Helper::jltma_content_alignment(),
        ...
        $this->add_responsive_control( 'ma_el_infobox_icon_hover_padding', [
            'label'      => __( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
        ...
        $this->start_controls_section( 'section_infobox_title', [
        ...
        $this->start_controls_tab( 'ma_el_infobox_title_color_normal', [
            'label' => __( 'Normal', 'master-addons' ),
        ] );
        ...
        $this->add_responsive_control( 'ma_el_infobox_title_alignment', [
            'label'       => esc_html__( 'Alignment', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'label_block' => false,
            'options'     => Master_Addons_Helper::jltma_content_alignment(),
        ...
        $this->add_responsive_control( 'ma_el_infobox_title_padding', [
            'label'      => __( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'ma_el_infobox_title_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_infobox_title_color_hover', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'ma_el_infobox_title_hover_alignment', [
            'label'       => esc_html__( 'Alignment', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'label_block' => false,
            'options'     => Master_Addons_Helper::jltma_content_alignment(),
        ...
        $this->add_responsive_control( 'ma_el_infobox_title_hover_padding', [
            'label'      => __( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
        ...
        $this->end_controls_section();
        // Description Style
        $this->start_controls_section( 'section_infobox_description', [
        ...
        $this->start_controls_tab( 'ma_el_infobox_desc_color_normal', [
            'label' => __( 'Normal', 'master-addons' ),
        ] );
        ...
        $this->add_responsive_control( 'ma_el_infobox_desc_alignment', [
            'label'       => esc_html__( 'Alignment', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'label_block' => false,
            'options'     => Master_Addons_Helper::jltma_content_alignment(),
        ...
        $this->add_responsive_control( 'ma_el_infobox_desc_padding', [
            'label'      => __( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'ma_el_infobox_desc_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_infobox_desc_color_hover', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
                ...
                '{{WRAPPER}} .jltma-infobox.four .jltma-infobox-item:hover .jltma-infobox-content-description,
							...
							{{WRAPPER}} .jltma-infobox.nine .jltma-infobox-item:hover .jltma-infobox-content-description' => 'color: {{VALUE}};',
            ],
        ] );
        $this->add_responsive_control( 'ma_el_infobox_desc_hover_alignment', [
            'label'       => esc_html__( 'Alignment', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'label_block' => false,
            'options'     => Master_Addons_Helper::jltma_content_alignment(),
        ...
        $this->add_responsive_control( 'ma_el_infobox_desc_hover_padding', [
            'label'      => __( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em', '%'],
            'selectors'  => [
    ...
    protected function render() {
		...
		<div id="jltma-infobox-<?php 
        echo esc_attr( $this->get_id() );
        ?>" class="jltma-infobox <?php 
        echo esc_attr( $settings['ma_el_infobox_preset'] );
        ?>">
        ...
        if ( $settings['ma_el_infobox_img_or_icon'] != 'none' ) {
            ?>
					...
					<?php 
            if ( $settings['ma_el_infobox_preset'] === "two" || $settings['ma_el_infobox_preset'] === "three" ) {
                ?>
                ...
                if ( 'img' == $settings['ma_el_infobox_img_or_icon'] ) {
                    ?>
								<img src="<?php 
                    echo esc_url( $infobox_image_url );
                    ?>" alt="<?php 
                    echo get_post_meta( $infobox_image['id'], '_wp_attachment_image_alt', true );
                    ?>">
							<?php 
                } else {
                    ...
                    if ( $is_new || $migrated ) {
                        \Elementor\Icons_Manager::render_icon( $settings['ma_el_infobox_icon'], [
                            'aria-hidden' => 'true',
                        ] );
                    } else {
                        ?>
            ...
            if ( $settings['ma_el_infobox_preset'] == "nine" ) {
                ?>
								...
								<?php 
                if ( $settings['ma_el_infobox_title_link']['url'] ) {
                    ?>
									<a href="<?php 
                    echo esc_url_raw( $settings['ma_el_infobox_title_link']['url'] );
                    ?>" <?php 
                    echo $this->get_render_attribute_string( 'ma_el_infobox_title_link_attr' );
                    ?>>
										<h3 class="jltma-infobox-content-title">
											<?php 
                    echo $this->parse_text_editor( $settings['ma_el_infobox_title'] );
                    ?>
										</h3>
									</a>
								<?php 
            ...
            ?>
							...
							<?php 
            if ( $settings['ma_el_infobox_preset'] == "five" || $settings['ma_el_infobox_preset'] == "eight" ) {
                ?>
        ...
        ?>
						...
						<p class="jltma-infobox-content-description">
							<?php 
        echo $this->parse_text_editor( $settings['ma_el_infobox_description'] );
        ?>
						</p>

						<?php 
        if ( $settings['ma_el_infobox_preset'] == "six" ) {
            ?>
							<a <?php 
            echo $this->get_render_attribute_string( 'ma_el_infobox_readmore_link' );
            ?> class="jltma-btn-learn" <?php 
            echo $this->get_render_attribute_string( 'ma_el_infobox_readmore' );
            ?>>
								<?php 
            echo esc_html( $settings['ma_el_infobox_readmore_text'] );
            ?>
