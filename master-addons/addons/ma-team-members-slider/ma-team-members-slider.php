...
class JLTMA_Team_Slider extends Widget_Base {
    ...
    protected function register_controls() {
        $this->start_controls_section( 'section_team_carousel', [
            'label' => esc_html__( 'Contents', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_team_carousel_preset', [
            ...
            'description'        => sprintf( '5+ more Variations on <a href="%s" target="_blank">%s</a>', esc_url_raw( admin_url( 'admin.php?page=master-addons-settings-pricing' ) ), __( 'Upgrade Now', 'master-addons' ) ),
        ] );
        $this->add_control( 'ma_el_team_circle_image', [
        ...
        $this->add_control( 'ma_el_team_circle_image_animation', [
            ...
            'description' => sprintf( '5+ More Animated Variations Available on Pro Version <a href="%s" target="_blank">%s</a>', esc_url_raw( admin_url( 'admin.php?page=master-addons-settings-pricing' ) ), __( 'Upgrade Now', 'master-addons' ) ),
        ] );
        $team_repeater = new Repeater();
        /*
         * Team Member Image
         */
        $team_repeater->add_control( 'ma_el_team_carousel_image', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_twitter_link', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_instagram_link', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_linkedin_link', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_dribbble_link', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_tiktok_link', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_youtube_link', [
        ...
        $team_repeater->add_control( 'ma_el_team_carousel_email_link', [
        ...
        $this->add_control( 'team_carousel_repeater', [
        ...
        $this->add_control( 'team_carousel_image_border_switch', [
            'label'   => esc_html__( 'Image Border?', 'master-addons' ),
            'type'    => Controls_Manager::SWITCHER,
            'default' => 'no',
        ] );
        $this->add_control( 'team_carousel_image_border_radius', [
         ...
         */
        $this->start_controls_section( 'ma_el_section_team_carousel_styles_preset', [
            'label' => esc_html__( 'General Styles', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_responsive_control( 'ma_el_team_image_bg_size', [
            ...
            'selectors'   => [
                '{{WRAPPER}} .jltma-team-member-circle .jltma-team-member-thumb svg,
						...
						{{WRAPPER}} .jltma-team-member-circle-animation .jltma-team-member-thumb' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
            ],
        ] );
        $this->add_responsive_control( 'ma_el_team_image_bg_position_left', [
        ...
        $this->add_responsive_control( 'ma_el_team_image_bg_position_top', [
        ...
        $this->add_responsive_control( 'ma_el_team_image_size', [
        ...
        $this->add_responsive_control( 'ma_el_team_image_position_left', [
        ...
        $this->add_responsive_control( 'ma_el_team_image_position_top', [
        ...
        $this->add_control( 'ma_el_team_carousel_avatar_bg', [
        ...
        $this->add_control( 'ma_el_team_carousel_bg', [
        ...
        $this->add_group_control( MA_Group_Control_Transition::get_type(), [
            'name'      => 'arrows',
        ...
        Style Tab: Name
        */
        $this->start_controls_section( 'section_team_carousel_name', [
            'label' => __( 'Name', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_title_color', [
        ...
        $this->add_control( 'ma_el_title_margins', [
        ...
        $this->end_controls_section();
        $this->start_controls_section( 'section_team_member_designation', [
            'label' => __( 'Designation', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_designation_color', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#8a8d91',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_designation_margins', [
            'label'       => esc_html__( 'Margin', 'master-addons' ),
            'type'        => Controls_Manager::DIMENSIONS,
            'size_units'  => ['px', 'em', '%'],
            'placeholder' => [
        ...
        $this->end_controls_section();
        $this->start_controls_section( 'section_team_carousel_description', [
            'label' => __( 'Description', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_description_color', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#8a8d91',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_description_margins', [
            'label'       => esc_html__( 'Margin', 'master-addons' ),
            'type'        => Controls_Manager::DIMENSIONS,
            'size_units'  => ['px', 'em', '%'],
            'placeholder' => [
        ...
        $this->start_controls_section( 'ma_el_team_carousel_social_section', [
        ...
        $this->add_control( 'ma_el_team_carousel_social_icon_color', [
        ...
        $this->add_control( 'ma_el_team_carousel_social_color_1', [
            'label'     => esc_html__( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#2231DD',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_team_carousel_social_icon_hover_color', [
            'label'     => esc_html__( 'Icon Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#FFF',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_team_carousel_social_hover_bg_color_1', [
            'label'     => esc_html__( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#DA0971',
            'selectors' => [
    ...
    protected function render() {
        ...
        $this->add_render_attribute( [
            ...
            'swiper-wrapper'      => [
                'class' => ['jltma-team-carousel', 'jltma-swiper__wrapper', 'swiper-wrapper'],
            ],
            'swiper-item'         => [
                'class' => [
                    'jltma-slider__item',
        ...
        $this->add_render_attribute( 'ma_el_team_slider_section', [
        ...
        if ( $team_preset == '-content-drawer' ) {
			...
			<div <?php 
            echo $this->get_render_attribute_string( 'ma_el_team_slider_section' );
            ?>>
				<!-- Gridder navigation -->
				<ul class="gridder">
            ...
            foreach ( $settings['team_carousel_repeater'] as $key => $member ) {
                ...
                ?>>
								...
								<span class="jltma-team-member-designation">
									<?php 
                echo esc_html( $member['ma_el_team_carousel_designation'] );
                ?>
								</span>
							</div>
						</li>
            ...
            foreach ( $settings['team_carousel_repeater'] as $key => $member ) {
                ...
                ?> class="jltma-team-member-name">
								<?php 
                echo $this->parse_text_editor( $member['ma_el_team_carousel_name'] );
                ?>
							</<?php 
                echo esc_attr( $settings['title_html_tag'] );
                ?>>
							<p class="jltma-team-member-desc">
								<?php 
                echo $this->parse_text_editor( $member['ma_el_team_carousel_description'] );
                ?>
							</p>
						</div>
						...
						<div class="jltma-content-right">
							<?php 
                if ( $member['ma_el_team_carousel_enable_social_profiles'] == 'yes' ) {
                    ?>
								<ul class="list-inline jltma-team-member-social">

									<?php 
                    if ( !empty( $member['ma_el_team_carousel_facebook_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_facebook_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_facebook_link']['url'] );
                        ?>" <?php 
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_twitter_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_twitter_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_twitter_link']['url'] );
                        ?>" <?php 
                        echo esc_attr( $target );
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_instagram_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_instagram_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_instagram_link']['url'] );
                        ?>" <?php 
                        echo esc_attr( $target );
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_linkedin_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_linkedin_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_linkedin_link']['url'] );
                        ?>" <?php 
                        echo esc_attr( $target );
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_dribbble_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_dribbble_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_dribbble_link']['url'] );
                        ?>" <?php 
                        echo esc_attr( $target );
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_tiktok_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_tiktok_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_tiktok_link']['url'] );
                        ?>" <?php 
                        echo esc_attr( $target );
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_youtube_link']['url'] ) ) {
                        ?>
										<?php 
                        $target = ( $member['ma_el_team_carousel_youtube_link']['is_external'] ? ' target="_blank"' : '' );
                        ?>
										<li>
											<a href="<?php 
                        echo esc_url( $member['ma_el_team_carousel_youtube_link']['url'] );
                        ?>" <?php 
                        echo esc_attr( $target );
                    ...
                    ?>
									...
									<?php 
                    if ( !empty( $member['ma_el_team_carousel_email_link'] ) ) {
                        ?>
										<li>
											<a href="mailto:<?php 
		...
		<?php 
            ...
            ?>>
				<div <?php 
            echo $this->get_render_attribute_string( 'ma_el_team_carousel' );
            ?>>
					<div <?php 
            ...
            foreach ( $settings['team_carousel_repeater'] as $key => $member ) {
                ...
                ?>
							...
							<div <?php 
                echo $this->get_render_attribute_string( 'swiper-item' );
                ?>>
								<div class="jltma-team-member<?php 
                echo esc_attr( $team_preset );
                ?> text-center">
                ...
                ?>>
										<span class="jltma-team-member-designation">
											<?php 
                echo $this->parse_text_editor( $member['ma_el_team_carousel_designation'] );
                ?>
										</span>
