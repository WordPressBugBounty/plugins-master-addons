...
if (!class_exists('MasterAddons\Modules\Animation\BgSlider')) {
class BgSlider
{
	...
	public static function ma_el_add_js_css()
	{
		...
		// JS - Vendor (registered with jltma- prefix by Assets_Manager)
		wp_enqueue_script('jltma-vegas');

		// JS - Module
		wp_enqueue_script('master-addons-bg-slider');
	}
