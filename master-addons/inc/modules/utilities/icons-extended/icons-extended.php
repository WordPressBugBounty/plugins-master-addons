...
if (!class_exists('MasterAddons\Modules\Utilities\IconsExtended')) {
class IconsExtended
{
	...
	*/
    ...
    public function jltma_add_icons_manager_tab($tabs)
    {
        ...
        $assets_url = trailingslashit(JLTMA_URL) . 'assets/';
        ...
        $tabs['elementor-icons'] = [
            ...
            'ver'           => JLTMA_VER,
            'fetchJson'     => $assets_url . 'fonts/elementor-icon/elementor-icons.js?v=' . JLTMA_VER,
            'native'        => true,
        ];
        ...
        $tabs['simple-line-icons'] = [
            ...
            'url'           => $assets_url . 'fonts/simple-line-icons/simple-line-icons.css',
            'enqueue'       => [$assets_url . 'fonts/simple-line-icons/simple-line-icons.css'],
            'prefix'        => 'icon-',
            'displayPrefix' => 'simple-line-icons',
            'labelIcon'     => 'jltma-icon jltma-icon-ma simple-line-icons icon-heart jltma-font-manager',
            'ver'           => JLTMA_VER,
            'fetchJson'     => $assets_url . 'fonts/simple-line-icons/simple-line-icons.js?v=' . JLTMA_VER,
            'native'        => false,
        ];
        ...
        $tabs['iconic-fonts'] = [
            ...
            'url'           => $assets_url . 'fonts/iconic-fonts/iconic-font.min.css',
            'enqueue'       => [$assets_url . 'fonts/iconic-fonts/iconic-font.min.css'],
            'prefix'        => 'im-',
            'displayPrefix' => 'im',
            'labelIcon'     => 'jltma-icon jltma-icon-ma iconic-fonts im im-flag jltma-font-manager',
            'ver'           => JLTMA_VER,
            'fetchJson'     => $assets_url . 'fonts/iconic-fonts/iconic-fonts.js?v=' . JLTMA_VER,
            'native'        => false,
        ];
        ...
        $tabs['linear-icons'] = [
            ...
            'url'           => $assets_url . 'fonts/linear-icons/linear-icons.css',
            'enqueue'       => [$assets_url . 'fonts/linear-icons/linear-icons.css'],
            'prefix'        => 'lnr-',
            'displayPrefix' => 'lnr',
            'labelIcon'     => 'jltma-icon jltma-icon-ma linear-icons lnr lnr-flag jltma-font-manager',
            'ver'           => JLTMA_VER,
            'fetchJson'     => $assets_url . 'fonts/linear-icons/linear-icons.js?v=' . JLTMA_VER,
            'native'        => false,
        ];
        ...
        $tabs['material-icons'] = [
            ...
            'url'           => $assets_url . 'fonts/material-icons/material-icons.css',
            'enqueue'       => [$assets_url . 'fonts/material-icons/material-icons.css'],
            ...
            'ver'           => JLTMA_VER,
            'fetchJson'     => $assets_url . 'fonts/material-icons/material-icons.js?v=' . JLTMA_VER,
            'native'        => false,
        ];


        // Pro Icon Libraries - filtered through Pro_Modules.php
        $pro_icons = apply_filters('master_addons/modules/icons_extended/pro_icons', [], $assets_url);
