...
namespace MasterAddons\Inc\Controls\Templates;
...
class JLTMA_Template_Controls
{
	...
	protected static function get_templates($args = [])
	{
		...
		return Helper::jltma_elementor()->templates_manager->get_source('local')->get_items($args);
	}
	...
	public static function render_template_content($id)
	{
		...
		$template = Helper::jltma_elementor()->frontend->get_builder_content_for_display($id);
