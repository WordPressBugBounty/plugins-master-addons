...
while ($jltma_wc_wp_query->have_posts()) {
    ...
    $excerpt = Helper::jltma_excerpt_truncate(get_the_excerpt(), esc_attr($excerpt_size), '...');

    if (Helper::jltma_get_featured_image_url() !== false) {
        $featured_image_src = aq_resize(esc_url(Helper::jltma_get_featured_image_url()), $image_width, $image_height, true, true, true);
    } else {
