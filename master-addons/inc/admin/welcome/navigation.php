...
<ul class="jltma-master-addons-tabs-navbar">
	...
	<?php echo apply_filters('master_addons/upgrade_pro', '<a class="jltma-upgrade-pro" href="https://master-addons.com/pricing" target="_blank">' . __('Upgrade Pro', 'master-addons') . '</a>'); ?>
