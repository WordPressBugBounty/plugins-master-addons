    ...
    class Latest_Updates extends Notice
    {
        ...
        public function notice_content()
        {
            $jltma_changelog_message = sprintf(
                ...
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> New Feature: Elementor Popup builder released</span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> New Feature: Elementor Template Kit library released</span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Fixed: Elementor editor now loads admin assets without any 404 errors</span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Improved: JavaScript now loads per-widget so only what is needed loads on each page</span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Improved: Admin menu order is now: Settings → Template Library → Theme Builder → Account → Support</span><br>', 'master-addons'),
            );
