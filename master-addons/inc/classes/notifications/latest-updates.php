    ...
    class Latest_Updates extends Notice
    {
        ...
        public function notice_content()
        {
            $jltma_changelog_message = sprintf(
                ...
                // Changelogs
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Fixed: Gallery Slider Thumbnails style issue fixed.</span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list"> Added: Some missing help links add to options settings.</span><br>', 'master-addons'),
            );
