    ...
    protected function jltma_swiper_navigation_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::SELECT,
                'default'   => 'center',
                'options'   => Helper::jltma_carousel_navigation_position(),
                'condition' => [
                    'navigation' => 'both',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => Helper::jltma_carousel_pagination_position(),
                'condition' => [
                    'navigation' => 'dots',
                ],
    ...
    protected function jltma_swiper_item_style_controls($name)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .jltma-team-carousel-slider:before' => is_rtl() ? 'background: linear-gradient(to left, {{VALUE}} 5%,rgba(255,255,255,0) 100%);' : 'background: linear-gradient(to right, {{VALUE}} 5%,rgba(255,255,255,0) 100%);',
                    '{{WRAPPER}} .jltma-team-carousel-slider:after'  => is_rtl() ? 'background: linear-gradient(to left, rgba(255,255,255,0) 0%, {{VALUE}} 95%);' : 'background: linear-gradient(to right, rgba(255,255,255,0) 0%, {{VALUE}} 95%);',
                ],
            ]
        );
                ...
                'carousel' => [
                    'data-settings' => [
                        wp_json_encode(array_filter([
                            ...
                            "slidesPerView"   => !empty($settings["columns_mobile"]) ? (int)$settings["columns_mobile"] : 1,
                            "slidesPerGroup"  => !empty($settings["slides_to_scroll_mobile"]) ? (int)$settings["slides_to_scroll_mobile"] : 1,
                            ...
                            "effect"          => ($settings["skin"] === "coverflow") ? "coverflow" : "slide",
                            "observer"        => true,
                            "observeParents"  => true,
                            "breakpoints"     => [
                                (int)$viewport_sm => [
                                    ...
                                    "slidesPerGroup" => !empty($settings["slides_to_scroll_tablet"]) ? (int)$settings["slides_to_scroll_tablet"] : 1,
                                ],
                                (int)$viewport_md => [
                                    "slidesPerView"  => !empty($settings["columns_tablet"]) ? (int)$settings["columns_tablet"] : 2,
                                    "spaceBetween"   => !empty($settings["item_gap_tablet"]["size"]) ? (int)$settings["item_gap_tablet"]["size"] : 0,
                                ...
                                1024 => [
                                    ...
                                    "spaceBetween"   => !empty($settings["item_gap"]["size"]) ? (int)$settings["item_gap"]["size"] : 0,
                                    "slidesPerGroup" => !empty($settings["slides_to_scroll"]) ? (int)$settings["slides_to_scroll"] : 1,
                                ],
                                (int)$viewport_lg => [
                                    "slidesPerView"  => !empty($settings["columns"]) ? (int)$settings["columns"] : 3,
                                    "spaceBetween"   => !empty($settings["item_gap"]["size"]) ? (int)$settings["item_gap"]["size"] : 0,
